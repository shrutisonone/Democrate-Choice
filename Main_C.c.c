	...
	while(1)
{
    ...
    printf("\n\n\n");
    printf("\t            ****** WELCOME TO THE Digital VOTING PLATFORM ******        \n\n");
...
node *main_logs(node *start)
{
    ...
    Sleep(300);
    printf("        \t\t\t3. FOR WINNER         \n");
    printf("    \t To-Be-Noted  IF YOUR DETAILS MATCHES WITH THOSE IN THE VOTER LIST THEN ONLY YOU CAN GIVE YOUR VOTE OTHERWISE YOU CAN NOT    \n\n\n");
    Sleep(500);
